...
if __name__=='__main__':
    ...
    st.image(
            final_image, caption=f"Sample Processed image", width=550,
                 )
    ...
    if file_uploaded is not None:    
        ...
        st.image(opencv_image, caption='Uploaded Image', width=350)
    ...
    if class_btn:
        if file_uploaded is None:
            ...
            with st.spinner('Model working....'):
                ...
                st.image(
                    final_image, caption=f"Processed image", width=350,
                      )
